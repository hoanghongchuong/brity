...
Route::get('du-an',['as'=>'getProduct', 'uses'=>'IndexController@getProduct']);
Route::get('du-an/{alias}.html','IndexController@getProductDetail')->name('detailProduct');
Route::get('du-an/{id}',['as'=>'getProductList', 'uses'=>'IndexController@getProductList']);
...
Route::get('dich-vu/{alias}', 'IndexController@getDetailService');
...
Route::group(['middleware' =>'authen', 'prefix' => 'backend'], function(){
	...
	Route::group(['prefix' => 'album'], function(){
		Route::get('/',['as'=>'admin.album.index','uses'=>'Admin\AlbumController@getList']);
		Route::get('add',['as'=>'admin.album.getAdd','uses'=>'Admin\AlbumController@getAdd']);
		Route::post('postAdd',['as'=>'admin.album.postAdd','uses'=>'Admin\AlbumController@postAdd']);
		Route::get('edit/{id}',['as'=>'admin.album.getEdit','uses'=>'Admin\AlbumController@getEdit']);
		Route::post('edit/{id}',['as'=>'admin.album.update','uses'=>'Admin\AlbumController@update']);
		Route::get('delete/{id}',['as'=>'admin.album.getDelete','uses'=>'Admin\AlbumController@getDelete']);

		Route::get('xoa/ajax', 'Admin\AlbumController@deleteAjax')->name('deleteAjax');
