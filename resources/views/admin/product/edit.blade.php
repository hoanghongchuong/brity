        ...
        <div class="box-body">
        	<form method="post" name="frmEditProduct" action="backend/product/edit?id={{$id}}" enctype="multipart/form-data">
	                  		...
	                  		<div class="row">
		                  		<div class="col-md-6 col-xs-12">
									...
									<div class="form-group">
								      	...
								      	<textarea name="txtHuongdan" rows="5" id="" class="form-control">{{ $data->huongdan }}</textarea>
									</div>									
								</div>
								<div class="col-md-12 col-xs-12">
									...
									<div class="form-group">
								      	...
								      	<textarea name="quatang" rows="5" id="txtContent" class="form-control">{{ $data->quatang }}</textarea>
									</div>
									<div class="form-group">
	                  	...
	                  	<div class="tab-pane" id="tab_2">
							...
							<div class="row">
								<div class="col-md-12 col-xs-12">
									...
									<div class="form-group">
								      	<label for="desc">Mô tả 2</label>
								      	<textarea name="quatang_en" rows="5" id="txtContent" class="form-control">{{ $data->quatang_en }}</textarea>
									</div>
			    ...
			    <div class="col-md-6">
                    ...
                    <div class="form-group">
					    <label>
				        	<input type="checkbox" name="big" {!! (!isset($data->big) || $data->big==1)?'checked="checked"':'' !!}> Big Images(Home)
				    	</label>
				    </div>
				    <!-- <div class="form-group">
					    <label>
