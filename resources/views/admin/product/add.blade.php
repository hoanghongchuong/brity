        ...
        <div class="box-body">        	
        	<form name="frmAdd" method="post" action="{!! route('admin.product.postAdd') !!}" enctype="multipart/form-data">
	                ...
	                <div class="tab-content">
	                  	<div class="tab-pane active" id="tab_1">
	                  		<div class="row">
		                  		<div class="col-md-6 col-xs-12">
									...
									<div class="form-group">
								      	...
								      	<textarea name="txtHuongdan" rows="5" id="" class="form-control"></textarea>
									</div>
								</div>
								<!-- <div class="col-md-6">
									<div class="form-group">
							...
							<div class="row">
								...
								<div class="form-group">
							      	<label for="desc">Mô tả 2</label>
							      	<textarea name="quatang" rows="5" id="txtContent" class="form-control"></textarea>
								</div>
	                  	...
	                  	<div class="tab-pane" id="tab_2">
							...
							<div class="row">
								<div class="col-md-12 col-xs-12">
									...
									<div class="form-group">
								      	<label for="desc">Mô tả 2</label>
								      	<textarea name="quatang_en" rows="5" id="txtContent" class="form-control"></textarea>
									</div>
									<div class="box box-info">
						                <div class="box-header">
						                  	<h3 class="box-title">Nội dung</h3>
	                	...
	                	<div class="tab-pane" id="tab_5">
	                		<div class="form-group">
	                  		...
	                  		<div class="form-group">
					    		<p><strong>Kiểu hiển thị</strong></p>
					    		<select name="type_view" id="" class="form-control">
					    			<option value="0">Kiểu 1</option>
					    			<option value="1">Kiểu 2</option>
					    			<option value="2">Kiểu 3</option>
					    			<option value="3">Kiểu 4</option>
					    		</select>
					    	</div>
	                  	</div>
			    ...
			    <div class="col-md-6">
                    ...
                    <div class="form-group">
					    <label>
				        	<input type="checkbox" name="big" > Big Images(Home)
				    	</label>
				    </div>
				    <!-- <div class="form-group">
					    <label>
