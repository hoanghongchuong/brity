                ...
                <div class="col-md-4 flex-center">
                    <div class="some-links">
                        <ul class="flex-center">
                            ...
                            <li><a href="{{ $setting->google }}" title="" class="fa fa-behance"></a></li>
                            <li><a href="{{ $setting->skype }}" title="" class="fa fa-dribbble"></a></li>
                           
                            <li><a href="{{ $setting->twitter }}" title="" class="fa fa-twitter"></a></li>
                            <li><a href="{{ $setting->instagram }}" title="" class="fa fa-instagram"></a></li>
                            <li><a href="{{ $setting->youtube }}" title="" class="fa fa-pinterest"></a></li>
