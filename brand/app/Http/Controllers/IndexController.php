	...
	*/
	...
	public function getProductDetail($id)
	{
		...
		if(!empty($product_detail)){
			...
			$com = 'detail';
			// End cấu hình SEO
			return view('templates.product_detail_tpl', compact('product_detail','banner_danhmuc','keyword','description','title','img_share','product_khac','album_hinh','cateProduct','productSameCate','tintucs','cate_pro', 'com'));
		}else{
			return redirect()->route('getErrorNotFount');
		}
	}
